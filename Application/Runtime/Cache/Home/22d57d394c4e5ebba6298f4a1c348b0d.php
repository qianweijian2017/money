...
<link rel="stylesheet" href="/Public/Home/css/personal_edit.css">
<div class="width100">
    <div class="nav_crumb">
    ...
    <div class="edit_left">
        ...
        <div class="personal_edit">
            <form action="<?php echo U('personal/doPersonal_edit');?>" method="post" enctype="multipart/form-data">
                <div class="touxiang_img">
                    <h5>头像照片</h5>
                    <span>仅支持JPG、GIF、PNG、JPEG、BMP格式，文件小于2M</span>
                    <div class="portrait_box">
                        <input type="file" name="user_portrait" class="portrait_img" data-default-file="/Public<?php echo ($user_info['user_portrait']); ?>">
                    </div>
                </div>
                <div class="edit_content">
                    <span>用户名：</span>
                    <input class="text" type="text" value="<?php echo ($user_info['user_name']); ?>" name="user_name">
                </div>
                <div class="edit_content gender">
                    <span>性别：</span>
                    <label><input type="radio" name="user_gender" <?=$user_info['user_gender']==1?'checked':''?> value="1">男</label>
                    <label><input type="radio" name="user_gender" <?=$user_info['user_gender']==2?'checked':''?> value="2">女</label>
                </div>
                <div class="edit_content birthday">
                    <span>生日：</span>
                    <select name="year"  id="birthdayYear">
                    ...
                    <label>月</label>
                    <select name="day" id="birthdayDay">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
...
<link rel="stylesheet" href="/Public/Lib/dropify/dropify.min.css">
<script src="/Public/Lib/dropify/dropify.min.js"></script>
<script>
    $('.portrait_img').dropify();
</script>
﻿
...
<script>
    var year=<?php echo ($arrBirthday[0]); ?>;
    var month=<?php echo ($arrBirthday[1]); ?>;
    var day=<?php echo ($arrBirthday[2]); ?>;
    var time_year=$('#birthdayYear option');
    var time_month=$('#birthdayMonth option');
    var time_day=$('#birthdayDay option');
function birthday(time,time_value){
    time.each(function () {
        if($(this).val()==time_value){
    ...
    birthday(time_year,year);
    birthday(time_month,month);
    birthday(time_day,day);
</script>