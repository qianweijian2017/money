...
<div class="width100">
    ...
    <div class="width1000 personal_con">
        <div class="bank">
            <form action="<?php echo U('personal/trader_pwd');?>" method="post">
                <div class="form_content">
                    <input class="input" type="password" name="trader_pwd" placeholder="6位数字交易密码"><br>
                    <input class="input" type="password" name="retrader" placeholder="再次输入交易密码"><br>
                </div>
                <div class="form_content">
                    <input class="submit" type="submit" value="设置">
                </div>
            </form>
        </div>
