...
<link rel="stylesheet" type="text/css" href="/ThinkPHP/Public/Home/css/detail.css">
	...
	<div class="content-in">
		...
		<div class="content_right">
			<div class="content_right_head">
				...
				<div>账户余额： <a href="" class="login">登入可见</a></div>
			</div>

			<div class="invest-box">
				<p style="font-size: 10px;">购买金额：</p>
				<div>
					<input id="investNum" class="invest-num" type="text" value="100">
					<span class="rmb">元</span>
					<div id="btnTotal" class="invest-total">全额</div>
				</div>

				<div class="lijibuy">立即购买</div>
  ...
  <div class="bs-example bs-example-taps" data-example-id="togglable-taps">
    ...
    <div id="myTabContent" class="tab-content">
      <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
         ...
         <div class="word">省心宝&middot;智惠系列是PPmoney理财平台推出的新型资金管理服务，加入省心宝的资金将由<span>PPmoney理财自主研发的借贷交易撮合系统（蜂巢系统）</span>代为分配投资标的，投资本金将自动实现债权对应匹配，投资者投资满30天后可随时申请退出，退出成功后按退出本金的比例结算对应收益，不退出可持续享有收益。</div>
      ...
      <div role="tabpanel" class="tab-pane fade" id="third" aria-labelledby="dropdown1-tab">
      	<div class=''>
      		<p class="strengthen">
      			由于债权标的项目受市场、政策、法律等各种因素的影响，PPmoney理财作为网贷信息中介平台主要提供信息发布和交易撮合服务，不向投资人或对借贷项目提供任何形式的担保，不承诺保本付息，无论是明示或暗示的。PPmoney理财提供的各种信息及资料仅供参考，不构成任何投资建议或引导，投资人应依其独立判断做出决策并承担由此带来的投资风险。
      		</p>
      		<p class="mt-30">
      ...
      <div role="tabpanel" class="tab-pane fade" id="forth" aria-labelledby="dropdown2-tab">
        <div class="stepup-tab-question">
          <h3>1、什么是省心宝？</h3>
          <p>答：省心宝是PPmoney理财为了兼顾投资者收益性和流动性的需求而特别推出的理财产品。利率固定，收益稳健；到期可退，期限灵活。</p>
          ...
          <p>答：PPmoney理财坚持向投资者披露每一笔资金的去向和每一笔借款的还款情况。投资完成后，具体债权的明细您可以登录电脑端【我的账户】，在【省心宝】中查看对应债权的明细。</p>
          ...
          <p>答：省心宝的锁定期是指省心宝的最短持有期限，在锁定期内不可以申请退出，锁定期后您可以随时申请退出，并且PPmoney理财不收取您任何退出费用。成功提交退出申请后，视债权转让交易情况而定，退出一般需要2~5个自然日。</p>
...
<div class="footer_f3 ">
 ...
 <script type="text/javascript" src="/ThinkPHP/Public/Home/js/detail.js"></script>