...
<link rel="stylesheet" type="text/css" href="/Public/Home/css/regular.css">
<link rel="stylesheet" type="text/css" href="/Public/Home/css/tc.css">

 
    <div class="big_pic"></div>

    <div class="fenlei">
    	<?php if(is_array($projlist)): $i = 0; $__LIST__ = $projlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$projitem): $mod = ($i % 2 );++$i;?><div class="prlist">
	    		<div class="prlist_title">
	    		   <span class="fir"><?php echo ($projitem['proj_lock']); ?>天定期宝<?php echo (date("Ymd-i",$projitem['create_time'])); ?></span>
	    		   
				</div>
				<div class="explain">
					<div class="main-rate">
						<span><?php echo ($projitem['pro_profit']); ?></span>
						<span>%</span>
						<span>预期年化收益率&nbsp;<i class="fa fa-question-circle-o"></i></span>
					</div>

					<div class="mod">
						<span class="total"><?php echo ($projitem["proj_lock"]); ?></span>
						<span class="num">天</span>
						<span class="hb">锁定期</span>
					</div>

					<div class="mod" style="margin-left: 50px;width: 100px;">
						<span class="total"><?php echo (intval($projitem['proj_total']/10000)); ?></span>
						<span class="num">万</span>
						<span class="hb">融资金额</span>
					</div>

					<div class="pro">			
						<?php $progress=($projitem['proj_amount'])/($projitem['proj_total'])*100; $progress=sprintf("%.2f",substr(sprintf("%.3f", $progress), 0, -2)); ?>	
						<div class="progress">
					...
					<div class="goumai">
						<a href="<?php echo U('detail',array('fixid'=>$projitem['id']));?>" target="_blank" class="goumai_btn">立即购买</a>
					</div> 
				</div>
 ...
 <div class="foow">
 	<span>粤ICP备16112898号-1</span>
 	<span>&nbsp;&nbsp;版权所有 © 深圳万惠金融服务有限公司</span>
 </div>
