        ...
        <div class="personal_left">
            <div class="personal_msg">
                ...
                <div class="portrait2">
                    ...
                    <p>注册号：<br><?php echo ($user_info['user_register']); ?></p>
            ...
            <ul class="state" title="实名认证">
                <?php $num=0; ?>
                <?php if($user_info['user_id_card'] == ''): ?><li><i class="state_icon1"></i><a href="<?php echo U('personal/personal_safe');?>">未认证</a></li>
                    <?php else: ?>
                    <li><i class="state_icon11"></i><a href="<?php echo U('personal/personal_safe');?>">已认证</a></li>
                    <?php $num+=1; endif; ?>
                <?php if($user_info['user_name'] == ''): ?><li><i class="state_icon2"></i><a href="<?php echo U('personal/personal_safe');?>">未保障</a></li>
                    <?php else: ?>
                    <li><i class="state_icon21"></i><a href="<?php echo U('personal/personal_safe');?>">已保障</a></li>
                    <?php $num+=1; endif; ?>
                <?php if($user_info['user_phone'] == ''): ?><li><i class="state_icon3"></i><a href="<?php echo U('personal/personal_safe');?>">未绑定</a></li>
                    <?php else: ?>
                    <li><i class="state_icon31"></i><a href="<?php echo U('personal/personal_safe');?>">已绑定</a></li>
                    <?php $num+=1; endif; ?>
                <?php if($user_info['user_email'] == ''): ?><li><i class="state_icon4"></i><a href="<?php echo U('personal/personal_safe');?>">未绑定</a></li>
                    <?php else: ?>
                    <li><i class="state_icon41"></i><a href="<?php echo U('personal/personal_safe');?>">已绑定</a></li>
                    <?php $num+=1; endif; ?>
            </ul>
            <div class="personal_grade">
                ...
                <div class="safedengji">
                    <span>安全等级：</span>
                    <div class="level"><div class="level_value" style="width: <?=$num*20?>px"></div></div>
                    <?php if($num*20 < 80): ?><div class="level_msg"><a href="<?php echo U('personal/personal_safe');?>">提升</a></div><?php endif; ?>
                </div>
            </div>
            ...
            <div class="personal_capital">
                <div class="personal_trade">
                    <div class="personal_trade_balance">
                        <span>账户余额：<h2><?php echo ($user_info['money']); ?></h2>元</span><a href="<?php echo U('personal/personal_bank');?>">绑定银行卡</a>
                    </div>
                    <div class="personal_trade_operate">
                        <a class="recharge" href="<?php echo U('personal/recharge');?>">充值</a>
                        <a class="cash"  href="<?php echo U('personal/withdraw');?>">提现</a>
                    </div>
                </div>
                <ul class="personal_profit">
                    <li>
                        <p>总资产<span>(元)</span></p>
                        <p class="cash"><?php echo ($user_info['user_all_money']); ?></p>
                        <p><a>查看详情></a></p>
                    </li>
                    <li>
                        <p>累计收益<span>(元)</span></p>
                        <p class="cash"><?php echo ($user_info['val_income']); ?></p>
                        <p><a>查看详情></a></p>
                    </li>
                    <li>
                        <p>我的积分</p>
                ...
                <p class="all_profit">累计投资：<span><?php echo ($user_info['count_invest']); ?></span>笔， 共计：<span><?php echo ($user_info['invest_money']); ?></span>元</p>
            </div>

            <ul id="myTab" class="nav nav-tabs xxk_title">
                <li class="active"><a href="#run" data-toggle="tab">进行中</a></li>
                <li><a href="#finish" data-toggle="tab">已完成</a></li>
                <li><a href="#not" data-toggle="tab">未完成</a></li>
            </ul>
            <div class="tab-content xxk_content">
                <div class="tab-pane fade in active" id="run">
                    <table class="table table-hover">
                        ...
                        <tbody class="tbody_ajax"></tbody>
                    </table>
                    <div class="pagination page_ajax"></div>
                </div>
                <div class="tab-pane fade" id="finish">
                    <table class="table table-hover">
                        ...
                        <tbody class="finish_tbody"></tbody>
                    </table>
                    <div class="pagination finish_page"></div>
                </div>
                <div class="tab-pane fade" id="not">
                    <table class="table table-hover">
                        ...
                        <tbody class="not_tbody"></tbody>
                    </table>
                    <div class="pagination not_page"></div>
                </div>
            </div>
...
<script rel="stylesheet" src="/Public/Home/js/personal.js"></script>
﻿
