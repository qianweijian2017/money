...
<div class="banner">
    <div class="banner-img carousel slide" id="slidershow" data-ride="carousel">
        <div class="banner-list carousel-inner">
            <img class="item active" src="/Public/Home/imgs/01.jpg" alt="">
    ...
    <div class="banner-box">
        <div id="login">
            ...
            <div class="banner-box-bd">
                <a href="<?php echo U('User/register');?>" class="btn-reg">注册领红包</a>
...
<div class="row main-detail" >
    <div class="container">
        <div class="col-lg-3 col-md-4 bg-blue bg-title">
            <div class="bg-up"></div>
            <div class="bg-box">
                <a href="http://cnt.ppmoney.com/special/2015/pplicai.html" class="download-btn" target="_blank" title="下载PPmoney理财客户端">
                    下载PPmoney理财客户端
                    <span class="download-qr-code"></span>
                </a>
            </div>
        ...
        <div class="col-lg-9 col-md-8 main-con">
            <ul class="bd-row">
                    ...
                    <div class="ft">
                        <div class="progress-box">
                            <div class="progress-box-c">
                                <div class="progress-ing" data-width="" style="width: 78.46%;"></div>
                        ...
                        <div class="invest-box cf">
                            <div class="btn-box">
                                ...
                                <a target="_blank" class="btn btn-primary">立即购买</a>
                ...
                <li>
                    <a href="http://cnt.ppmoney.com/special/2015/pplicai.html" target="_blank"><img class="p-t35"
                                                                                                    src="https://special.ppmoney.com/2016/10/pp.png"></a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="tab-content ">
                    ...
                    <div class="page-col-5 detail-text  pull-right">
                        <ul>
                            <li>
                                ...
                                <p>3月24日，李克强总理和特恩布尔总理出席中国澳大利亚首席执行官圆桌会议和中国-澳大利亚经贸合作论坛。此次，昭昭理财万惠集团董事长陈宝国也成为中国经贸代表团成员，受邀出席此次论坛。</p>
                            </li>
                            <li>
                ...
                <div class="tab-pane detail-text " id="Media_reports">
                    <ul class="date-color">
                        ...
                        <li>
                            <a href="javascript;:" class="pull-left"><strong>[网贷天眼]</strong>昭昭理财胡新：广东网贷管理办法强化投资者教育</a>
                ...
                <div class="tab-pane " id="powder_activity">
                    <ul class="">
                        <li class="page-col-5 pull-left">
                            <a href="#" >
                                <img src="/Public/Home/imgs/00002_20170227104927.jpeg" alt="" class="img-responsive">
                                <span>昭昭理财粉丝见面会在穗举行 共迎存管...</span>
                            </a>
                        </li>
                        <li class="page-col-5 pull-right">
                            <a href="#" >
                                <img src="/Public/Home/imgs/00003_20170227104931.jpeg" alt="" class="img-responsive">
                            </a>
